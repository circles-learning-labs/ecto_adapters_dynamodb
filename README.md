...
defp deps do
  [
    {:ecto_adapters_dynamodb, git: "https://github.com/circles-learning-labs/ecto_adapters_dynamodb", tag: "3.1.2"}
  ]
end
```
...
Please see the instructions [here](https://github.com/circles-learning-labs/ecto_adapters_dynamodb/blob/main/upgrade_guides/version_1_upgrade_guide.md)

### 1.X.X -> 2.X.X

Please see the instructions [here](https://github.com/circles-learning-labs/ecto_adapters_dynamodb/blob/main/upgrade_guides/version_2_upgrade_guide.md)

### 2.X.X -> 3.X.X

Please see the instructions [here](https://github.com/circles-learning-labs/ecto_adapters_dynamodb/blob/main/upgrade_guides/version_3_upgrade_guide.md)
