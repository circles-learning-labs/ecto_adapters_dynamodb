defmodule Ecto.Adapters.DynamoDB.Query do
  ...
  defp should_query?(indexes, [{logical_op, search_clauses} | additional_search_clauses])
       when logical_op in @logical_ops,
       do:
         should_query?(indexes, search_clauses) or
           should_query?(indexes, additional_search_clauses)
