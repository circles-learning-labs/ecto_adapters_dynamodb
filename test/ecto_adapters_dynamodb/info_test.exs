defmodule Ecto.Adapters.DynamoDB.Info.Test do
  ...
  test "index_details" do
    assert %{
      ...
      secondary: [
        %{
          "IndexArn" => "arn:aws:dynamodb:ddblocal:000000000000:table/test_person/index/first_name_age",
        ...
        %{
          "IndexArn" => "arn:aws:dynamodb:ddblocal:000000000000:table/test_person/index/age_first_name",
        ...
        %{
          "IndexArn" => "arn:aws:dynamodb:ddblocal:000000000000:table/test_person/index/first_name",
        ...
        %{
          "IndexArn" => "arn:aws:dynamodb:ddblocal:000000000000:table/test_person/index/first_name_email",
        ...
        %{
          "IndexArn" => "arn:aws:dynamodb:ddblocal:000000000000:table/test_person/index/email",
          "IndexName" => "email",
          "IndexSizeBytes" => 0,
          "IndexStatus" => "ACTIVE",
          "ItemCount" => 0,
  ...
  test "repo_primary_key" do
    ...
    assert_raise ArgumentError, "DynamoDB repos must have a single primary key, but repo Elixir.Ecto.Adapters.DynamoDB.TestSchema.BookPage has more than one", fn ->
