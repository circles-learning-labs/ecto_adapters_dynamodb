defmodule Ecto.Adapters.DynamoDB.Integration.ExAws.Dynamo.Test do
  ...
  test "Decoder.decode()" do
    ...
    assert Dynamo.Decoder.decode(%{"BS" => ["U3Vubnk=", "UmFpbnk=", "U25vd3k="]}) == MapSet.new(["U3Vubnk=", "UmFpbnk=", "U25vd3k="])
    assert Dynamo.Decoder.decode(%{"SS" => ["foo", "bar", "baz"]}) == MapSet.new(["foo", "bar", "baz"])
